/*
 * This file contains a component to render a page about establishing a
 * positive classroom community.
 */

/*
 * The ESLint commands below allow the use of an <a name="..."> tag below.
 */
  ...
  return (
    <PageContent>
      ...
      <SectionBox>
        ...
        <ul>
          <li><a href="http://contributor-covenant.org/" target="_blank" rel="noopener noreferrer">Contributor Covenant</a> &ndash; a code of conduct shared by many open source projects, including Atom, Eclipse, Mono, Rails, Swift, and many more.</li>
          <li><a href="https://www.mozilla.org/en-US/about/governance/policies/participation/" target="_blank" rel="noopener noreferrer">Mozilla Community Participation Guidelines</a></li>
          <li><a href="https://www.python.org/community/diversity/" target="_blank" rel="noopener noreferrer">Python Diversity Statement</a></li>
          <li><a href="https://www.ubuntu.com/about/about-ubuntu/conduct" target="_blank" rel="noopener noreferrer">Ubuntu Code of Conduct</a></li>
          <li><a href="http://www.acm.org/sigs/volunteer_resources/officers_manual/code%20of%20conduct" target="_blank" rel="noopener noreferrer">ACM Code of Conduct</a></li>
        </ul>
        <p>
          Note that promoting diversity is also a <a href="http://leadership.oregonstate.edu/strategicplan" target="_blank" rel="noopener noreferrer">core value of Oregon State University</a> and a <a href="http://engineering.oregonstate.edu/coe-strategic-plan" target="_blank" rel="noopener noreferrer">goal of the College of Engineering</a>.
        </p>
        ...
        <ul>
          <li>You may <a href="mailto:greendan@oregonstate.edu">schedule a private meeting</a> to talk to me.</li>
